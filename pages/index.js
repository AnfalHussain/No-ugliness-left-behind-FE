        ...
        <div class="col-start-1 row-start-1 flex sm:col-start-2 sm:row-span-3">
          <div class="w-full grid grid-cols-3 grid-rows-2 gap-2">
            <div class="relative col-span-3 row-span-2 md:col-span-2">
              <img
                src="https://images.horchow.com/ca/2/product_assets/H/B/P/9/U/HCHBP9U_mu.jpg"
                alt=""
            ...
            <div class="relative hidden md:block">
              <img
                src="https://i.pinimg.com/originals/5b/14/bf/5b14bf0a8ded1ad77df5e748afb2c5c4.jpg"
                alt=""
            ...
            <div class="relative hidden md:block">
              <img
                src="https://i.pinimg.com/originals/ae/56/07/ae5607f8984370d16be39aa7cae27536.jpg"
                alt=""
                class="absolute inset-0 w-full h-full object-cover rounded-lg bg-gray-100"
              />
            </div>
